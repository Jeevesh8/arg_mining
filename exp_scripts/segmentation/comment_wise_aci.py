...
from transformers import BertTokenizer, BertModel, LongformerTokenizer, LongformerModel, RobertaTokenizer, RobertaModel
...
def get_tok_model(args, tokenizer_version, model_version):
    if args.model_type == "bert":
        ...
        raise ValueError("Model type not supported. Use bert, roberta, or longformer.")
...
### Define layers for a Linear-Chain-CRF and Loss function
